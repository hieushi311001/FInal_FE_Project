    ...
    const fetchData = async () => {
      try {
        if (userToken) {
          ...
          showSuccessNotification("Success!", "Thanks for rating our product!");
  ...
  return (
    <div className="tab-pane fade" id="tab-3" role="tabpanel">
      <div className="customer-review-option">
        ...
        />
        <div className="comment-option " style={{ marginTop: "30px" }}>
          <div className="row justify-content-center h-100 w-100 ">
            <div className="card custom-1">
              <div className="card-body p-4">
                <h4 className="text-center mb-4 pb-2">User Comment</h4>
                <div className="row">
                  <div className="col">
